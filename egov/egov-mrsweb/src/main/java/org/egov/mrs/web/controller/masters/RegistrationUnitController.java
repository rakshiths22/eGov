...
public class RegistrationUnitController {
    ...
    public String createRegistrationunit(
        ...
        validateRegUnit(errors, marriageRegistrationUnit);
        if (errors.hasErrors()) {
            prepareNewForm(model);
            return REGISTRATIONUNIT_CREATE;
        }
    ...
    public String ajaxsearchRegistrationunit(@PathVariable("mode") final String mode,
            Model model, @ModelAttribute final MarriageRegistrationUnit marriageRegistrationUnit) {
    ...
    public String updateRegistrationunit(@Valid @ModelAttribute final MarriageRegistrationUnit marriageRegistrationUnit,
    ...
    public void validateRegUnit(final BindingResult errors,final MarriageRegistrationUnit regUunit){
        if(regUunit.getName() == null){
            errors.rejectValue("name", "Notempty.regUnit.name",null);
        }
        if(regUunit.getAddress() == null){
            errors.rejectValue("address", "Notempty.regUnit.address",null);
        }
        if(regUunit.getZone() == null){
            errors.rejectValue("zone", "Notempty.regUnit.zone",null);
        }
    }
