...
public class ReligionController {
    ...
    public String createReligion(
        ...
        validateMrgReligion(errors, marriageReligion);
        if (errors.hasErrors())
            return MRG_RELIGION_CREATE;
    ...
    public void validateMrgReligion(final BindingResult errors,final MarriageReligion religion){
        if(religion.getName() == null){
            errors.rejectValue("name", "Notempty.religion.name",null);
        }
    }
}
