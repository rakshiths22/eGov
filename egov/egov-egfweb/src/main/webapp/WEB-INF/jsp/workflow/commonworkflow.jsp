	...
	function getUsersByDesignationAndDept() {
		populateapproverPositionId({
			approverDepartmentId : document
					.getElementById('workflowBean.approverDepartment').value,
...
<s:if test="%{getNextAction()!='END'}">
	<s:if test="%{!'Closed'.equalsIgnoreCase(currentState)}">
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
		...
		<tr>
			...
			<td class="${approverOddTextCss}" width="14%"><s:select
					name="workflowBean.approverDepartment" id="approverDepartment"
