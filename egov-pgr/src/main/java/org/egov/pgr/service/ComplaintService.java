...
public class ComplaintService {
    ...
    public Complaint createComplaint(final Complaint complaint) throws ValidationException {
      ...
      /*  if (complaint.getChildLocation() != null && complaint.getChildLocation().getParent() != null)
            complaint.getChildLocation()
                    .setParent(boundaryService.getBoundaryById(complaint.getChildLocation().getParent().getId()));*/
